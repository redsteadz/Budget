...
<div id="income-modal" class="modal" style="display: none;" role="dialog" aria-labelledby="income-modal-title" aria-hidden="true">
    <div class="modal-content">
        ...
        <form id="income-form">
            ...
            <div class="form-group">
                <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                    <input type="checkbox" id="income-excluded-from-forecast" style="width: 18px; height: 18px; cursor: pointer;">
                    <span><?php p($l->t('Exclude from forecast (extraordinary)')); ?></span>
                </label>
                <small class="form-text"><?php p($l->t('Transactions generated by this income are left out of forecast averages.')); ?></small>
            </div>
